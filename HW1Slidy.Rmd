...
Here is a picture from a forest in the Guanacaste region in Costa Rica contrasting the wet (rigth) and the dry (left) season (Source: [Guanacaste dry forest conservation fund](http://www.gdfcf.org/biodiversity-species))
...
```{r summer temperature and winter ppt, echo= FALSE}
